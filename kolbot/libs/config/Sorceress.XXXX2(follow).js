...
function LoadConfig() {
	...
	Scripts.AutoSmurf = true;
		...
		Config.AutoSmurf.TeleportingSorc = "ftest-A";  //your leader sor charname.
		Config.AutoSmurf.NonSorcChar = ["ftest-B", "ftest-C"]; //all team charname except from leader and boBar
		Config.AutoSmurf.BoBarb = "ftest-D";	//boBar charname
		Config.AutoSmurf.AllTeamProfiles = ["As1","As2","As3","As4"];  //  all team PROFILE Names
		
	Config.AutoEquip = false;

	// Team MF system
	Config.MFLeader = false; // Set to false if you have one or more MFHelpers. Opens TP and gives commands when doing normal MF runs.
	...
	*/
	...
	Config.Leader = "ftest-A"; // Leader's ingame character name. Leave blank to try auto-detection (works in AutoBaal, Wakka, MFHelper)
	Config.QuitList = ["ftest-A"]; // leader char name
	...
	Config.PickitFiles.push("auto/white2.nip"); // advance white1.nip
